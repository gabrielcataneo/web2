    ...
    <div id="page-content-wrapper">
          ...
          <div class="py-5">
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <h1 class="">Cadastrar Livro</h1>
                <br/>
            <form>
          <div class="form-group">
            <label for="nomeDoLivro">Nome do Livro</label>
            <input type="text" class="form-control" id="nomeDoLivro"  placeholder="Digite o nome do livro">
          </div>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="descricaoLivro" rows="3"></textarea>
          </div>
          <div class="form-group">
            <label for="capaLivro">Capa do Livro</label>
            <input type="file" class="form-control-file" id="capaLivro" aria-describedby="capaLivro">
            <small id="capaLivro" class="form-text text-muted">Insira uma imagem tamanho tal x tal.</small>
          </div>
